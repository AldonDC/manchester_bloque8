"""
Nodo: trajectory_set_point_generator  —  Set-Point Generator
=============================================================
Mini Challenge 4 · Manchester Robotics

ROL EN EL RETO:
    Genera los waypoints de la figura elegida (square/triangle/hexagon)
    y los envía al Controller. Es el "cerebro" de la trayectoria.
    Sirve para que el robot recorra figuras mientras Localisation
    propaga Σ_k y RViz dibuja la elipse creciendo en cada esquina.

PROTOCOLO DE COORDINACIÓN:
    [t = 2 s]  envía primer waypoint (delay inicial para que arranquen los nodos)
    [llegada]  Controller publica next_point=True
    [t + 2 s]  envía siguiente waypoint (delay para estabilizar)
